...
<head>
    ...
    <title>Invoice Comparison - KMG Dashboard</title>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Upload PDF invoice and Excel data for comparison
                </p>
            </div>
            
            <form class="mt-8 space-y-6" action="{{ route('invoice.compare.process') }}" method="POST" enctype="multipart/form-data">
                @csrf
